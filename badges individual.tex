...
\newcommand{\BadgeWidth}{5.5cm}
\newcommand{\BadgeHeight}{8.5cm}
...
\definecolor{eventD}{RGB}{255,100,0}
\colorlet{eventC}{purple}
...
\newcommand{\attendsEventA}{\attendance{0}{eventA}{High-school}{-\Fudge}{0}}
\newcommand{\attendsEventB}{\attendance{1}{eventB}{General Attendee}{0}{0}}
\newcommand{\attendsEventC}{\attendance{2}{eventC}{Speaker}{0}{0}}
\newcommand{\attendsEventD}{\attendance{3}{eventD}{Volunteer}{0}{\Fudge}}
...
\begin{document}
  ...
  \csvreader{participants.csv}{%
    ...
    3=\eventA,4=\eventB,5=\eventC,6=\eventD}%
  {
